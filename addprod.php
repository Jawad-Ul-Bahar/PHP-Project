...
if(isset($_POST['add'])){
   ...
   if($extension=='png'|| $extension=='jpg' || $extension== 'jpeg' || $extension=='jfif' || $extension=='webp'){

    if(move_uploaded_file($ptmpname,$destination)){
        $q=mysqli_query($con, "INSERT INTO `product`(`name`, `price`, `quantity`, `cat_id`, `image`) VALUES ('$name','$price','$qty','$category','$image')");
